...
json_dump(meta, '/work/datasets/disaster/my_project/meta.json')
'''


for object in os.listdir('/work/datasets/disaster/img/'):
    name = object[:-4]
    print(name)
    im = cv2.imread('/work/datasets/disaster/img/' + object)
    temp = cv2.resize(im, (0, 0), fx=1.5, fy=1.5)
    cv2.imwrite('/work/datasets/disaster/my_project/dataset/img/' + object, temp)
    image = cv2.imread('/work/datasets/disaster/my_project/dataset/img/' + object)


    mat = scipy.io.loadmat('/work/datasets/disaster/masks/' + name + '.mat')
    mask = mat['M']
    ...
    json_dump(json_for_image, '/work/datasets/disaster/my_project/dataset/ann/' + name + '.json')
